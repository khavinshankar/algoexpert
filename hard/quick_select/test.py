...
the kth smallest number in that array in linear time, on average. The array could be sorted, but 
...
class TestProgram(unittest.TestCase):
    ...
    def test_case_15(self):
        self.assertEqual(
            program.quickselect(
                [102, 41, 58, 81, 2, -5, 1000, 10021, 181, -14515, 25, 15], 4
            ),
            15,
        )
    ...
    def test_case_16(self):
        self.assertEqual(
            program.quickselect(
                [102, 41, 58, 81, 2, -5, 1000, 10021, 181, -14515, 25, 15], 9
            ),
            102,
        )
