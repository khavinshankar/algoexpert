...
need to appear consecutively in order to form a subsequence. Assume that there will only be 
...
class TestProgram(unittest.TestCase):
    ...
    def test_case_4(self):
        self.assertEqual(
            program.longestCommonSubsequence("ABCDEFG", "ABCDEFG"),
            ["A", "B", "C", "D", "E", "F", "G"],
        )

    def test_case_5(self):
        self.assertEqual(
            program.longestCommonSubsequence("ABCDEFG", "APPLES"), ["A", "E"]
        )

    def test_case_6(self):
        self.assertEqual(
            program.longestCommonSubsequence("clement", "antoine"), ["n", "t"]
        )

    def test_case_7(self):
        self.assertEqual(
            program.longestCommonSubsequence("ZXVVYZW", "XKYKZPW"), ["X", "Y", "Z", "W"]
        )
