...
connected nodes where no node is connected to more than two other nodes; a path sum is the sum of the 
values of the nodes in a particular path. Each Binary Tree node has a value stored in a property 
...
class TestProgram(unittest.TestCase):
    ...
    def test_case_5(self):
        test = BinaryTree(1).insert(
            [-10, -5, 30, 45, -20, -21, 5, 1, 3, -3, 100, 2, 100, 1]
        )
