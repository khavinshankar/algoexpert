...
class TestProgram(unittest.TestCase):
    def test_case_1(self):
        self.assertEqual(program.mergeSort([1]), [1])

    def test_case_2(self):
        self.assertEqual(program.mergeSort([1, 2]), [1, 2])

    def test_case_3(self):
        self.assertEqual(program.mergeSort([2, 1]), [1, 2])

    def test_case_4(self):
        self.assertEqual(program.mergeSort([1, 3, 2]), [1, 2, 3])

    def test_case_5(self):
        self.assertEqual(program.mergeSort([3, 1, 2]), [1, 2, 3])

    def test_case_6(self):
        self.assertEqual(program.mergeSort([1, 2, 3]), [1, 2, 3])
